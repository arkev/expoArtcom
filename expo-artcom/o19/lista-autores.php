...
<head>
  <meta charset="utf-8">
  <title>Fichas por autor &middot; <?php echo $coleccion; ?></title>
...
<body id="<?php echo $expo_section; ?>">
  ...
  <div id="container">
    <header>
      <?php include 'nav.php'; ?>
      <h1>Fichas por autor</h1>
        <div id="search">
              <label for="filter">Filtrar</label> <input type="text" name="filter" value="" id="filter" placeholder="Escribe tu nombre para encontrar tus fichas"/>
            </div>
    </header>
