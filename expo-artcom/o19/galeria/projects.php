...
<script>
    ...
    ?>
     	...
     	<img id="imagen" src="../slir/w720/expo-artcom/p12/upload/<?php echo $row['nuevo'];?>" /> 
	...
	<div class="descripcion">	
					<div class="fb-like" data-href="http://artcom.um.edu.mx/expo-artcom/p12/galeria/projects.php?id=<?php echo $id; ?>" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
					<br><br>
