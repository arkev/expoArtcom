...
<script type="text/javascript">
		...
		var template = '<dl class="proyecto"> \
			<dd id="ajax_status" class="feedback" style="display:block"></dd> \
	...
	?>
		...
		<input type="text" pattern="[0-9]*" name="proyecto_id" value="" id="proyecto_id" placeholder="Nº" autofocus> <input type="submit" name="" value="Agregar" id="add_btn">
		</form>
	<?php
		}else{
